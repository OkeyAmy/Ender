...
interface SidebarInputProps {
  onSubmit: (url: string, style: string, model: string, instructions?: string, scraper?: string) => void;
  disabled?: boolean;
}
...
export default function SidebarInput({ onSubmit, disabled = false }: SidebarInputProps) {
  ...
  const handleSubmit = (e?: React.FormEvent) => {
    ...
    onSubmit(url.trim(), selectedStyle, selectedModel, additionalInstructions || undefined, selectedScraper);
      ...
      <div >
        ...
        {isValidUrl && (
          <div className="p-4 space-y-4">
            ...
            {/* Scraper Selector */}
            <div>
              <label className="block text-xs font-medium text-gray-700 mb-2">Scraper</label>
              <ScraperSelector
